...
""", unsafe_allow_html=True)
    ...
    # Box Legenda Ambang Batas Spasial
    st.markdown(f"""
...
""", unsafe_allow_html=True)
    ...
    with col_r1:
        ...
        if status["text"] == "SANGAT BAIK":
            ...
            st.info(f"**Kondisi normal.** Angin dominan bertiup dari arah **{arah_nama}** ({dir_deg:.0f}°). Kawanan pelagis bergerak aktif mengikuti dinamika sirkulasi massa air permukaan di perairan.")
        else:
